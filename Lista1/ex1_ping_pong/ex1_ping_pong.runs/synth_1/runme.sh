...
HD_PWD='C:/Users/Misael/Desktop/UNB/7 SEMESTRE/PROJETO DE CIRCUITOS RECONFIGURAVEIS/Lista1/ex1_ping_pong/ex1_ping_pong.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ping_pong_rtl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ping_pong_rtl.tcl
